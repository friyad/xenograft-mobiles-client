...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded lg:rounded-md text-2xs sm:text-xs 2xl:text-sm 3xl:text-base font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50  transition-transform duration-200 active:scale-[0.98] shadow-sm hover:shadow-lg transition-all duration-200 select-none",
  {
    variants: {
      variant: {
        default:
