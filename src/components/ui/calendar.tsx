  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav: "space-x-4 flex items-center ml-4",
        nav_button: cn(
          buttonVariants({ variant: "outline" })
          // "h-7 w-7 bg-bl p-0 opacity-50 hover:opacity-100"
        ),
        ...
        day: cn(
          ...
          "size-9 p-0 font-normal aria-selected:opacity-100 !rounded-none"
        ),
      ...
      components={{
        IconLeft: () => <ChevronLeft className="size-4 2xl:size-5" />,
        IconRight: () => <ChevronRight className="size-4 2xl:size-5" />,
      }}
      {...props}
    />
  );
